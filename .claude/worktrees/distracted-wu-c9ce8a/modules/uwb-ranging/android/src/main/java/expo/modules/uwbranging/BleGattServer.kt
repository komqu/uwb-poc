...
internal class BleGattServer(
    ...
    fun start(pairingCode: String) {
        ...
        // Embed the pairing code as manufacturer-specific data so the controlee
        // can identify this device without touching the system Bluetooth name.
        // 0xFFFF is the reserved/test company ID — fine for a PoC.
        val data = AdvertiseData.Builder()
            .setIncludeDeviceName(false)
            .addServiceUuid(ParcelUuid(serviceUuid))
            .addManufacturerData(0xFFFF, pairingCode.toByteArray(Charsets.UTF_8))
            .build()
